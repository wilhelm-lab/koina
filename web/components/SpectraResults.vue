...
import type { Spectrum } from '@/utils/transform-spectrum'
...
<template>
  ...
  <!-- using inline styles here so they still work if they get teleported into rapidoc shadow DOM -->
  <Accordion
    type="single"
    collapsible
  >
      ...
      >
        ...
        <ChevronDown
          :style="{
            ...
            transform: openKey === spectrum.key ? 'rotate(180deg)' : 'rotate(0deg)',
          }"
        />
      </AccordionTrigger>
