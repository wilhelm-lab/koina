  ...
  <div>
    ...
    <div class="bg-neutral-100">
      <div class="py-16 px-4 max-w-5xl mx-auto">
        ...
        <p>
          ...
          <a href="mailto:Ludwig.Lautenbacher@tum.de">please contact us via E-Mail</a>.
        </p>
        <p class="mb-8">
        ...
        <BaseButton
          to="/docs#overview--adding-your-own-model"
          class="ml-4"
        >
          Add your model
        </BaseButton>
    ...
    <div class="py-16 px-4 max-w-5xl mx-auto">
      ...
      <div class="flex justify-around flex-wrap">
        <a
          href="https://www1.ls.tum.de/en/compms/home/"
          class="mb-2"
        >
          <img
            src="~/assets/img/tum-logo.png"
            alt="TUM logo"
            class="h-16"
          >
        </a>
