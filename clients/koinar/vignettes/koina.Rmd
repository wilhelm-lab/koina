...
package: koinar
abstract: |
  How to use KoinaR `r BiocStyle::Biocpkg('koina')`
output:
...
Here we take a look at KoiaR the R package to simplify interfacing with Koina. 
...
# Requirements
KoinaR requires only `httr` for sending requests to the server.
