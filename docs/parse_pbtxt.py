...
def composeGraphViz(input, label='ES'):
    ...
    for k in es:
        ...
        for i in es[k]['input']:
            ...
            if "in:value:" in i and i in ri:
                edgeTmp = edgeTmp + '''\t\t"{}":"{}" -> "{}":"{}";\n'''.format(ri[i], i.replace('in:value', 'out:value').replace(":", "_"), k, i.replace(":", "_"))
    ...
    for k in inputNodes:
        ...
        print ('''| <input> {} {}'''.format(inputNodes[k]['data_type'], inputNodes[k]['dims']), end = '')
        print ('''" shape="record"];''')
    for k in es:
        for i in es[k]['input']:
            if "in:value:" in i and not i in ri:
                print('''\t\t"{}":"{}" -> "{}":"{}"\n'''.format(i.replace(":", "_").replace("in_value_", ""), "input", k, i.replace(":", "_")))
    print ("\t}")
    ...
    for k in outputNodes:
        ...
        print ('''| <output> {} {}'''.format(outputNodes[k]['data_type'], outputNodes[k]['dims']))
        print ('''"\nshape="record"\n];''')
    ...
    for k in es:
        for i in es[k]['output']:
            ...
            if out in outputNodes:
                print('''\t\t"{}":"{}" -> "{}":output'''.format(k, i.replace(":", "_"), out.replace(":", "_")))
