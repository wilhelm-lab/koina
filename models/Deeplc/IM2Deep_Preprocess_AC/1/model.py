...
aa_count_dict = {
    "A": [1 + 2, 2 + 3, 0 + 1, 0 + 1, 0, 0],
    "R": [4 + 2, 9 + 3, 3 + 1, 0 + 1, 0, 0],
    "N": [2 + 2, 3 + 3, 1 + 1, 1 + 1, 0, 0],
    "D": [2 + 2, 2 + 3, 0 + 1, 2 + 1, 0, 0],
    "C": [1 + 2, 2 + 3, 0 + 1, 0 + 1, 1, 0],
    "Q": [3 + 2, 5 + 3, 1 + 1, 1 + 1, 0, 0],
    "E": [3 + 2, 4 + 3, 0 + 1, 2 + 1, 0, 0],
    "G": [0 + 2, 0 + 3, 0 + 1, 0 + 1, 0, 0],
    "H": [4 + 2, 4 + 3, 2 + 1, 0 + 1, 0, 0],
    "I": [4 + 2, 8 + 3, 0 + 1, 0 + 1, 0, 0],
    "L": [4 + 2, 8 + 3, 0 + 1, 0 + 1, 0, 0],
    "K": [4 + 2, 9 + 3, 1 + 1, 0 + 1, 0, 0],
    "M": [3 + 2, 6 + 3, 0 + 1, 0 + 1, 1, 0],
    "F": [7 + 2, 6 + 3, 0 + 1, 0 + 1, 0, 0],
    "P": [3 + 2, 4 + 3, 0 + 1, 0 + 1, 0, 0],
    "S": [1 + 2, 2 + 3, 0 + 1, 1 + 1, 0, 0],
    "T": [2 + 2, 4 + 3, 0 + 1, 1 + 1, 0, 0],
    "W": [9 + 2, 7 + 3, 1 + 1, 0 + 1, 0, 0],
    "Y": [7 + 2, 6 + 3, 0 + 1, 1 + 1, 0, 0],
    "V": [3 + 2, 6 + 3, 0 + 1, 0 + 1, 0, 0],
    "X": [0 + 2, 0 + 3, 0 + 1, 0 + 1, 0, 0],
    "U": [0 + 2, 0 + 3, 0 + 1, 0 + 1, 0, 0],
    "B": [0 + 2, 0 + 3, 0 + 1, 0 + 1, 0, 0],
    "J": [0 + 2, 0 + 3, 0 + 1, 0 + 1, 0, 0],
    "O": [0 + 2, 0 + 3, 0 + 1, 0 + 1, 0, 0],
    "Z": [0 + 2, 0 + 3, 0 + 1, 0 + 1, 0, 0],
}
