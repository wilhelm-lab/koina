...
import numpy as np
from lib import encode_mod_features, strip_mod_profroma, character_to_array, get_mod_features
...
class TritonPythonModel:
   ...
   def execute(self, requests):
     ...
     for request in requests:
      ...
      responses.append(pb_utils.InferenceResponse(output_tensors=[seq_out, mod_out]))
     return responses
   def finalize(self):
